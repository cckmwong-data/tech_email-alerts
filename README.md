...
* **Dynamic Valuation:** An interactive 2-stage DCF engine featuring a Weighted Average Cost of Capital (WACC) vs. Terminal Growth sensitivity matrix.
...
* **Automated ETL:** Python scripts and GitHub Actions refresh the entire financial dataset along the pipeline every 24 hours, while the data is stored at Google Sheet and Google BigQuery. Power BI report is scheduled for a daily refresh at designated time.
